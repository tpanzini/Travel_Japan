...
//thumbnail listenrs
// tokyoThumbnail.addEventListener('click', changeSlider);
osakaThumbnail.addEventListener("click", changeSlider);
naraThumbnail.addEventListener("click", changeSlider);
kyotoThumbnail.addEventListener("click", changeSlider);
